...
public class ConfigReaderRedisTest {

    @Test
    public void redisDataStore() {
        final StandaloneConfig config = ConfigReader.parse(ConfigReaderRedisTest.class.getResourceAsStream("/simplepush-redis-config.json"));
